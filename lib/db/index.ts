...
const SCHEMA_STATEMENTS = [
  ...
  `alter table characters drop column if exists clothing`,
  `update characters
    set
  ...
  `alter table shots add column if not exists character_action text`,
  `alter table shots add column if not exists lighting_mood text`,
  ...
  `alter table shots drop column if exists description`,
  `alter table shots drop column if exists camera_angle`,
  `alter table shots drop column if exists narration`,
  `alter table shots drop column if exists notes`,
